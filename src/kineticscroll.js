// https://github.com/ariya/kinetic/ --> Number 2
/* configs: {
    indicator --> ID to a absolute positioned element inside the container
...
export function kineticscroll(node, cfgs) {
    ...
    let min = 0;
    let pressed = false;
    let defaultConfigs = { indicator: '', usewheel: false, speed: 500 };
